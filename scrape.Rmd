...
We need to join the dates to the data frames as an additional column, concatenate the data frames to form a single table, and perform other cleanups.  This is most easily done all at once.

```{r}
form_df <- function (table, date) {
  # combine a single table and a single date
